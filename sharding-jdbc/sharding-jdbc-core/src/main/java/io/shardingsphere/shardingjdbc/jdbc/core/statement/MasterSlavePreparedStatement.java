...
public final class MasterSlavePreparedStatement extends AbstractMasterSlavePreparedStatementAdapter {
    ...
    /**
     * 创建一个MasterSlavePreparedStatement
     * @param connection 基于读写分离的数据库连接 MasterSlaveConnection
     * @param sql sql语句
     * @param resultSetType
